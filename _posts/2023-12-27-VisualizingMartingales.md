...
------
The conditional expectation $$E[x_3 \mid x_1,x_2]$$ is the expected value of $$x_3$$ given the measurement results for $$x_1$$ and $$x_2$$. 

So in this example, where we know that the event $$W$$ (the four colored segments) is true, $$E[x_3 \mid x_1,x_2]$$ is a random variable that maps any outcome in $$W$$ to a single value, namely the average of $$x_3$$ over the event $$W$$.
